            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="userresult.jsp">Home <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="col-md-3 mt-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="bookNow.htm?id=${cc.id}" class="btn btn-danger text-center btn-block">BOOK NOW</a><br><br>
                                <a href="new.jsp" class="btn btn-primary" width="100px">Advance Booking Payment</a>
                            </div>
                        </div>
                    </div>
                </c:forEach>
